...
class StatisticsViewModelTest {
    ...
    fun loadNonEmptyTasksFromRepository_NonEmptyResults() = runTest {
        ...
        val task1 = Task(id = "1", title = "Title1", description = "Desc1",priority = 0,
            dueDate = System.currentTimeMillis(),isCompleted = true)
        val task2 = Task(id = "2", title = "Title2", description = "Desc2", priority = 0,
            dueDate = System.currentTimeMillis(),isCompleted = true)
        val task3 = Task(id = "3", title = "Title3", description = "Desc3", priority = 0,
            dueDate = System.currentTimeMillis(),isCompleted = true)
        val task4 = Task(id = "4", title = "Title4", description = "Desc4", priority = 0,
            dueDate = System.currentTimeMillis(),isCompleted = true)
