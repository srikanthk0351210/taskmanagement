...
class TasksViewModelTest {
    ...
    fun setupViewModel() {
        ...
        val task1 = Task(id = "1", title = "Title1", description = "Desc1", isCompleted = true, priority = 0, dueDate = System.currentTimeMillis())
        val task2 = Task(id = "2", title = "Title2", description = "Desc2", isCompleted = true,priority = 0, dueDate = System.currentTimeMillis())
        val task3 = Task(id = "3", title = "Title3", description = "Desc3", isCompleted = true,priority = 0, dueDate = System.currentTimeMillis())
    ...
    fun completeTask_dataAndSnackbarUpdated() = runTest {
        ...
        val task = Task(id = "id", title = "Title", description = "Description",priority=0,dueDate = System.currentTimeMillis())
    ...
    fun activateTask_dataAndSnackbarUpdated() = runTest {
        ...
        val task = Task(id = "id", title = "Title", description = "Description", isCompleted = true, priority = 0, dueDate = System.currentTimeMillis())
        tasksRepository.addTasks(task)
