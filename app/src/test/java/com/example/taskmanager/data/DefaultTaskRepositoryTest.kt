...
import com.example.taskmanager.data.source.local.FakeTaskDao
import com.example.taskmanager.data.source.network.FakeNetworkDataSource
...
class DefaultTaskRepositoryTest {
    ...
    private val task1 = Task(id = "1", title = "Title1", description = "Description1", priority = 0,dueDate = System.currentTimeMillis())
    private val task2 = Task(id = "2", title = "Title2", description = "Description2", priority = 0,dueDate = System.currentTimeMillis())
    private val task3 = Task(id = "3", title = "Title3", description = "Description3", priority = 0,dueDate = System.currentTimeMillis())

    private val newTaskTitle = "Title new"
    private val newTaskDescription = "Description new"
    private val newTask = Task(id = "new", title = newTaskTitle, description = newTaskDescription, priority = 0,dueDate = System.currentTimeMillis())
    ...
    fun saveTask_savesToLocalAndRemote() = testScope.runTest {
        ...
        val newTaskId = taskRepository.createTask(newTask.title, newTask.description,newTask.priority,newTask.dueDate)
