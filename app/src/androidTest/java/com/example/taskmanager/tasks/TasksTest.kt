...
import com.example.taskmanager.TodoNavGraph
...
class TasksTest {
    ...
    fun editTask() = runTest {
        ...
        repository.createTask(originalTaskTitle, "DESCRIPTION", priority = 0, dueDate = System.currentTimeMillis())
    ...
    fun createTwoTasks_deleteOneTask() = runTest {
        repository.apply {
            createTask("TITLE1", "DESCRIPTION", priority = 0, dueDate = System.currentTimeMillis())
            createTask("TITLE2", "DESCRIPTION", priority = 0, dueDate = System.currentTimeMillis())
        }
    ...
    fun markTaskAsCompleteOnDetailScreen_taskIsCompleteInList() = runTest {
        ...
        repository.createTask(taskTitle, "DESCRIPTION", priority = 0, dueDate = System.currentTimeMillis())
    ...
    fun markTaskAsActiveOnDetailScreen_taskIsActiveInList() = runTest {
        ...
        repository.apply {
            createTask(taskTitle, "DESCRIPTION", priority = 0, dueDate = System.currentTimeMillis()).also { completeTask(it) }
        }
