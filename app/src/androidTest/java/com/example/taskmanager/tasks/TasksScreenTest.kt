...
import com.example.taskmanager.HiltTestActivity
...
class TasksScreenTest {
    ...
    fun displayTask_whenRepositoryHasData() = runTest {
        ...
        repository.createTask("TITLE1", "DESCRIPTION1", priority = 0, dueDate = System.currentTimeMillis())
    ...
    fun displayCompletedTask() = runTest {
        repository.apply {
            createTask("TITLE1", "DESCRIPTION1", priority = 0, dueDate = System.currentTimeMillis()).also { completeTask(it) }
        }
    ...
    fun showAllTasks() = runTest {
        ...
        repository.apply {
            createTask("TITLE1", "DESCRIPTION1", priority = 0, dueDate = System.currentTimeMillis())
            createTask("TITLE2", "DESCRIPTION1", priority = 0, dueDate = System.currentTimeMillis()).also { completeTask(it) }
        }
    ...
    fun showActiveTasks() = runTest {
        ...
        repository.apply {
            createTask("TITLE1", "DESCRIPTION1", priority = 0, dueDate = System.currentTimeMillis())
            createTask("TITLE2", "DESCRIPTION2", priority = 0, dueDate = System.currentTimeMillis())
            createTask("TITLE3", "DESCRIPTION3", priority = 0, dueDate = System.currentTimeMillis()).also { completeTask(it) }
        }
    ...
    fun showCompletedTasks() = runTest {
        ...
        repository.apply {
            createTask("TITLE1", "DESCRIPTION1" , priority = 0, dueDate = System.currentTimeMillis())
            createTask("TITLE2", "DESCRIPTION2" , priority = 0, dueDate = System.currentTimeMillis()).also { completeTask(it) }
            createTask("TITLE3", "DESCRIPTION3", priority = 0, dueDate = System.currentTimeMillis()).also { completeTask(it) }
        }
