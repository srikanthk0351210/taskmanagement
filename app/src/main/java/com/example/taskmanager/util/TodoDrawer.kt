...
import com.example.taskmanager.TodoDestinations
import com.example.taskmanager.TodoNavigationActions
    ...
    Surface(color = MaterialTheme.colorScheme.background) {
        Column(modifier = modifier.fillMaxSize()) {
            ...
            DrawerButton(
                ...
                isSelected = currentRoute == TodoDestinations.SETTINGS_ROUTE,
                action = {
                    navigateToSettings()
                    closeDrawer()
                }
